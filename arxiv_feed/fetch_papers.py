#!/usr/bin/env python3
"""Fetch the latest arXiv papers matching AI/ML keywords and write to papers.json."""
...
# ── Configuration ──────────────────────────────────────────────────────────────
SEARCH_QUERY = 'cat:cs.AI AND (all:"large language model" OR all:"machine learning")'
MAX_RESULTS = 20
